...
public class ConfigurationActivity extends AppCompatActivity implements DatePickerDialog.OnDateSetListener {
    ...
    public void onDateSet(android.widget.DatePicker view, int year, int month, int dayOfMonth) {
        ...
        AppWidget.updateWidget(this, appWidgetManager, widgetID);
